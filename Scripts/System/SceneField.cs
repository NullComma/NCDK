...
#pragma warning restore 414
        ...
        /// <summary>
        /// Creates a SceneField. Ideally, provide the full Asset Path for Bundle compatibility.
        /// </summary>
        /// <param name="sceneIdentifier">Scene name or "Assets/..." path.</param>
        public SceneField(string sceneIdentifier)
        {
        ...
        public static implicit operator string(SceneField sceneField) => sceneField?.ToString() ?? "";

        public static bool operator ==(SceneField a, SceneField b)
        {
            if (ReferenceEquals(a, null)) return ReferenceEquals(b, null);
            return a.Equals(b);
        }

        public static bool operator !=(SceneField a, SceneField b) => !(a == b);
