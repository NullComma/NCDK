...
#if UNITY_EDITOR
    [CustomEditor(typeof(BlockingEventsTrigger))]
...
#pragma warning disable CS0618 // Type or member is obsolete
            var oldComp = (BlockingEventsTrigger)target;
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private void FixExternalReferences(BlockingEventsTrigger oldComp, BlockingEventsTrigger newComp)
        {
            ...
            {
                string msg = "<b>[ATENÇÃO]</b> Existem scripts referenciando 'BlockingEventsTrigger' explicitamente no código.\n" +
