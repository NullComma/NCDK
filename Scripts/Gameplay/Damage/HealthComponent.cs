...
namespace NullCore {
	...
	/// </summary>
	public class HealthComponent : Hitbox {
		...
		[Space]
		[SerializeField] private TransformShake _transformShake;
		...
		public override HealthComponent Health => this;
		...
		public event Action<float, HitInfoData, Transform> OnDamageTaken;
		...
		/// </summary>
		public override float TakeHit(HitInfoData attack, Transform attacker, float damageMultiplier) {
			if (IsDead) return 0f;
