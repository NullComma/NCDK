...
namespace NullCore {
	public class DamageDealerTrigger : MonoBehaviour, ICDamageDealer {
		...
		public void Initialize(AttackData attack, float damageMultiplier = 1f) {
			attackData = attack;
		...
		[FormerlySerializedAs("attack")] [FormerlySerializedAs("_hitInfo")] [SerializeField] private AttackData attackData;
